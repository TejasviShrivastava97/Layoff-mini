...
const SuccessPage: React.FC<SuccessPageProps> = ({ setView }) => {
  const fileUrl = '/The-Layoff-Proof-Playbook.pdf';
  const fileName = 'The-Layoff-Proof-Playbook.pdf';
    ...
    <div className="pt-32 pb-32 px-6 flex items-center justify-center min-h-[80vh]">
      <div className="container mx-auto max-w-2xl text-center animate-reveal">
        ...
        <p className="text-xl text-slate-500 mb-12 leading-relaxed font-medium">
          Your payment was successful. You now have full access to <span className="text-slate-950 font-bold">The Layoff-Proof Playbook</span>.
        </p>
          ...
          <div className="bg-white rounded-[2.8rem] p-8 md:p-12 relative z-10 border border-white/10">
            <div className="flex flex-col items-center">
              ...
              <div className="relative mb-8 group-hover:scale-105 transition-transform duration-500 shadow-2xl">
                ...
                <div className="w-32 h-44 md:w-40 md:h-56 bg-[#f5ede3] rounded-lg overflow-hidden border border-slate-200 flex flex-col relative">
                  <div className="h-1 bg-[#8B6343] w-full"></div>
                  <div className="p-4 flex-1 flex flex-col justify-between">
                    <div className="space-y-1.5">
                      <div className="h-1.5 w-full bg-slate-300/50 rounded"></div>
                      <div className="h-1.5 w-3/4 bg-slate-300/30 rounded"></div>
                      <div className="h-1.5 w-1/2 bg-slate-300/30 rounded"></div>
                    </div>
                    <div className="text-left">
                      <p className="text-[9px] font-bold text-slate-800 leading-tight uppercase tracking-wide">THE LAYOFF-PROOF<br/>PLAYBOOK</p>
                      <p className="text-[7px] font-black text-[#8B6343] uppercase tracking-widest mt-1">Elemental Ventures</p>
                    </div>
                  </div>
              ...
              <h2 className="text-2xl font-serif font-bold text-slate-950 mb-2">The Layoff-Proof Playbook</h2>
              <p className="text-sm text-slate-500 mb-8 font-medium">Full Playbook • Digital PDF • Instant Download</p>
        ...
        <div className="bg-slate-50 p-8 md:p-10 rounded-[3rem] border border-slate-200 shadow-sm mb-12 text-left">
          ...
          <div className="flex gap-4 items-start">
            <div className="mt-1 w-5 h-5 text-emerald-600 flex-shrink-0">
