...
const FAQ: React.FC = () => {
  const faqs = [
    { q: "How long does the assessment take?", a: "Most professionals complete the full 6-dimension diagnostic in 5-10 minutes. The value comes from the objective analysis of your current role dynamics." },
    { q: "Is the assessment really free?", a: "Yes. The Replaceability Scorecard assessment is completely free. After seeing your results, you'll have the option to purchase The Layoff-Proof Playbook for $27 — a step-by-step framework to improve your score." },
    { q: "What is the 14-day guarantee on the Playbook?", a: "If you feel The Layoff-Proof Playbook didn't provide meaningful professional insight, simply email us within 14 days and we'll issue a full refund. No questions asked." },
    ...
    { q: "Is the Playbook a recurring subscription?", a: "Absolutely not. The Layoff-Proof Playbook is a one-time $27 payment for lifetime access to the PDF and any future edition updates." },
