      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="prose prose-slate max-w-none text-slate-600 font-medium leading-relaxed space-y-12">
          ...
          <section className="space-y-4">
            ...
            <p>We offer a no-questions-asked 14-day money back guarantee on The Layoff-Proof Playbook. If it doesn't provide you with the clarity or value you expected, email us for a full refund of your $27. Beyond 14 days, refunds are reviewed individually for technical or access failures.</p>
          </section>
